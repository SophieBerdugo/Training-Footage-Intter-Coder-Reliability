...
icc(displacement_rate, #data frame
    ...
    conf.level = 0.95) #confidence level
```
**ICC estimates and their 95% confidence intervals were calculated using R (v. 4.0.3) based on a single rater (k = 2), absolute-agreement, two-way mixed effects model. The ICC score indicated good reliability.** 
